...
# print("plinkRscript")
# print(paste("yType=", phenoType))
# print(paste("nResampling=", opt$`n-resampling`))
# print(paste("typeResampling=", opt$`type-resampling`))
# print(paste("adjustment=", !opt$`no-adjustment`))
# print(paste("kernel=", opt$kernel))
# print(paste("impute-method=", opt$`impute-method`))
