...
class VariantDataset(object):
    ...
    def set_va_attribute(self, ann_path, key, value):
        ...
        **Examples**
        ...
        >>>   'va.filters = if((v.altAllele.isSNP && (va.info.QD < 2.0 || va.info.FS < 60 || va.info.MQ < 40 || va.info.MQRankSum < -12.5 || va.info.ReadPosRankSum < -8.0)) || ' \
        >>>   '(va.info.QD < 2.0 || va.info.FS < 200.0 || va.info.ReadPosRankSum < 20.0)) va.filters.add("HardFilter")' \
        >>>   'else va.filters'])
